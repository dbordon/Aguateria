          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=update" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="permisos_acceso" required>
                    <option value="<?php echo utf8_encode($data['permisos_acceso']); ?>"><?php echo utf8_encode($data['permisos_acceso']); ?></option>
                    <option value="Super Admin">Super Admin</option>
                    <option value="Academico">Recepción</option>
                    <option value="Marketing">Direccción</option>v
                  </select>
                </div>
              </div>
            </div><!-- /.box body -->
