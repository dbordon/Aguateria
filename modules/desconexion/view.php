...
<div class="row">
    <div class="col-md-6">
  <h1>
    <i class="fa fa-folder-o icon-title"></i>Imprimir notificación de Desconexión con más de 3 Meses de morosidad</h1>
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped dt-responsive tablas" width="100%">
            ...
            <div align="center" class="box box-secound">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Actualizar lista" class="btn btn-primary btn-sm" href="main.php?module=desconexion">
...
?>
              <td width="20" class="center">
               <a data-toggle="tooltip" data-placement="top" title="Imprimir Notificación" class="btn btn-warning btn-sm" 
                  href="modules/desconexion/print.php?act=imprimir&CliCod=<?php echo $data['Codigo_Cliente']; ?>" target="_blank">
