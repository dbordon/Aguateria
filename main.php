...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Sistema - Seguimiento de Morosidad</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Sistema de Recepción de Currículum">
    <meta name="author" content="Sistema de Recepción de Currículum - Dbordon" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=start" class="logo">
          <img src="assets/img/agualogo.png" alt="Logo" > 
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="#" target="_blank">By Focustec</a>.</strong> <p><a href="https://api.whatsapp.com/send?phone=+595971786590" target="_blank"> Consultas aquí</a></p>
      </footer>
    </div><!-- ./wrapper -->
